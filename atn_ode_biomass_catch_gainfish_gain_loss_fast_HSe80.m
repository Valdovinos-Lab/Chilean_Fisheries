function dXdt = atn_ode_biomass_catch_gainfish_gain_loss_fast_HSe80(~,X,Data)
% ----------------------------------------------------------------------- %
% ----------------------------- PARAMETERS ------------------------------ %
% ----------------------------------------------------------------------- %
...
%all basal 50=0.125,80=0.22,100=100
ProducerFisheries = ((0.125*bProducerGuilds)/100).*ProducerHarvest;

%all consumers without filters and hervibores 50=10,80=25,100=100
Hconsumers = ((10*bConsumerGuilds([1,4,7,10,12:18,23],:))/100);

%all filters and hervibores 50=23,80=80,100=100
...
plankton = dBdt(95,:);
plankton = plankton + ((61291*21.6)/100);
dBdt(95,:) = plankton;
