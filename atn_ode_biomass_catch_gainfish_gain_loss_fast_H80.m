function dXdt = atn_ode_biomass_catch_gainfish_gain_loss_fast_H80(~,X,Data)
% ----------------------------------------------------------------------- %
% ----------------------------- PARAMETERS ------------------------------ %
% ----------------------------------------------------------------------- %
...
ProducerFisheries = ((0.22*bProducerGuilds)/100).*ProducerHarvest;
%calculating the removal to harvested species 
%all consumers without filters and hervibores
Hconsumers = ((25*bConsumerGuilds([1,4,7,10,12:18,23],:))/100);
%all filters and hervibores
HfilandHerb = ((80*bConsumerGuilds([29,34,46],:))/100);
